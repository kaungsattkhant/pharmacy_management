<div class="modal fade" id="category_edit" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document" style="width: 480px;">
        <div class="modal-content border-0 btr-mount">
            ...
            <div class="modal-header modal-title-bg text-center pb-1 border-0 btr-mount">
                <h5 class="text-center mx-auto" id="exampleModalLongTitle">Edit Category</h5>
            ...
            <div class="modal-body mx-5 px-0">
                ...
                <form>
                    ...
                    <div class="m-button pt-3">
                        ...
                        <button type="submit" class="btn btn-nb-mount2 fontsize-mount22 px-3 cs-btn" id="categorySubmit1">Save</button>
                    </div>
                </form>
            </div>
