            ...
            <div class="modal-body mx-5 px-0">
                ...
                <form>
                    ...
                    <div class="mb-3 ">
                        ...
                        <input type="text" id="expire_date" autocomplete="off"  class="date_picker border-top-0 border-right-0 border-left-0 rounded-0 mount-input col-md-7">
                    </div>
                    <span class="text-danger" id="expire_date_error">
                                </span>
