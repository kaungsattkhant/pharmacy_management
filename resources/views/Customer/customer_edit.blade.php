    ...
    <div class="modal-dialog modal-dialog-centered" role="document" style="width: 480px;">
        <div class="modal-content border-0 btr-mount">
            <div class="modal-header modal-title-bg text-center pb-1 border-0 btr-mount">
                <h5 class="text-center mx-auto" id="exampleModalLongTitle">Edit Customer</h5>
                ...
                <form>
                    ...
                    <span class="text-danger">
                        ...
                        <div class="mb-3 {{$errors->has('email') ? 'has:error':''}}">
                            ...
                            <input type="text" id="nrc1" class="border-top-0 border-right-0 border-left-0 rounded-0 mount-input col-md-7">
                        </div>
                        <span class="text-danger">
                                    <strong id="nrc_error1"></strong>
                                </span>
                        <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="special_note1" class="border-top-0 border-right-0 border-left-0 rounded-0 mount-input col-md-7"></textarea>
                    </div>
                    <span class="text-danger">
                                    <strong id="special_note_error1"></strong>
                    </span>
